...
export const PROJECTS_FEATURED = [
  {
    ...
    type: 'Portfolio',
    headline: 'A portfolio that behaves like a working drawing.',
  ...
  },
  {
    ...
    type: 'AI / Voice',
    headline: 'A voice interface that shows its work.',
    ...
    href: 'https://connection-assistant.vercel.app',
    source: `${GH}/Connection-Voice-Assistant`,
    period: 'LIVE',
  },
  {
    name: 'neuron',
    ...
    type: 'Full Stack',
    headline: 'Twenty-four builds, made explorable.',
    highlight: 'LIVE — 24 PROJECTS CATALOGUED',
    tech: ['FastAPI', 'TypeScript', 'SQLAlchemy', 'Neon'],
    desc: 'A field catalogue of 24 CS projects with instant search, taxonomy filters, complete build plans, and AI-tailored constraints.',
    href: 'https://neuron-database.vercel.app',
    source: `${GH}/Neuron-Project-Database`,
    period: 'LIVE',
  },
  {
    name: 'neurosurge',
    ...
    type: 'Full Stack',
    headline: 'Knowledge you can navigate, not just store.',
    highlight: 'LIVE — NOTES AS A GRAPH',
    tech: ['React', 'FastAPI', 'Neon', 'Force Graph'],
    desc: 'A second brain where wikilinked notes become a force-directed atlas, semantic search, and spaced-repetition rehearsal.',
    href: 'https://neurosurge.vercel.app',
    source: `${GH}/Neurosurge-Second-Brain`,
    period: 'LIVE',
  },
  {
    name: 'scribbly',
    label: 'Scribbly — Collaborative Whiteboard',
    type: 'Full Stack',
    headline: 'A shared canvas that remembers.',
    highlight: 'LIVE — CURSORS, REPLAY & EXPORT',
    tech: ['React', 'Canvas', 'Liveblocks', 'FastAPI', 'Neon'],
    desc: 'A shared drawing room with live cursors, persistent stroke history, timeline replay, and SVG/PNG export.',
    href: 'https://scribbly-collab.vercel.app',
    source: `${GH}/Scribbly-Collaborative-Whiteboard`,
    period: 'LIVE',
  },
];
...
const REF = {
  ...
  connection: R('Connection — voice assistant', 'https://connection-assistant.vercel.app'),
  neuron: R('Neuron — project database', 'https://neuron-database.vercel.app'),
